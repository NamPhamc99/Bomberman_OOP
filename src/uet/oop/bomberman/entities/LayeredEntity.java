...
public class LayeredEntity extends Entity {
    ...
    public boolean collide(Entity e) {
        ...
        if (e instanceof Flame && this.getTopEntity() instanceof Brick) {
            this.getTopEntity().collide(e);
        }

        if (this.getTopEntity() instanceof Brick) return false;

        if (this.getTopEntity() instanceof Item ) {
            ((Item)this.getTopEntity()).play_item_sound();
            this.getTopEntity().collide(e);
        }

        if (this.getTopEntity() instanceof Portal) this.getTopEntity().collide(e);
        return true;
    }
}
